  ...
  <nav class="sidebar">
    ...
    <div class="menu-content">
      <ul class="menu-items">
        ...
        <li class="item">
          <a href="data_inventaris.php" id="active"> <svg xmlns="http://www.w3.org/2000/svg" width="38" height="24"
              ...
              <path
                ...
                fill="#18181B" />
              <path d="M13 2.5V5C13 7.357 13 8.536 13.732 9.268C14.464 10 15.643 10 18 10H22" stroke="#18181B"
                stroke-width="1.5" />
            </svg>Data Barang</a>
        </li>
        <li class="item">
        ...
        <table id="table-barang" class="table table-striped" style="width:100%">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td><?php echo $data["ketegori_barang"]; ?></td>
              <td><?php echo $data["harga_barang"]; ?></td>
              <td><?php echo $data["stok_barang"]; ?></td>
              <td><?php echo $data["tanggal_pembelian"]; ?></td>
              <td class="edit-hapus-barang">
                <a href="#"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 1 19 18"
                    fill="none">
                    <path
